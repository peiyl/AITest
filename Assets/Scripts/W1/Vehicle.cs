...
public class Vehicle : MonoBehaviour {
    ...
    //控制力的计算间隔时间，为了达到更高的帧率，操控力不需要每帧更新
    public float computrInterval = 0.2f;
    //是否在二维平面上，如果是，计算两个game object的距离时忽略Y值的不同
	...
	void Update () {
        ...
        steeringForce = new Vector3(0, 0, 0);
        //如果距离上次计算操控力的时间大于设定的时间间隔
        //再次计算操控力
        if (timer>computrInterval)
        {
